...
class SellerTaxonomyNode(BaseModel):
    """
    ...
    children: Optional[List[SellerTaxonomyNode]] = Field(default=None, description="An array of taxonomy nodes for all the direct children of this taxonomy node in the seller taxonomy tree.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [SellerTaxonomyNode.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None,
            "full_path_taxonomy_ids": obj.get("full_path_taxonomy_ids")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
SellerTaxonomyNode.model_rebuild(raise_errors=False)
