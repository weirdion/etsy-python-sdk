...
class ListingInventoryWithAssociations(BaseModel):
    """
    A representation of a single listing's inventory record with associations
    """ # noqa: E501
    products: Optional[List[ListingInventoryProduct]] = Field(default=None, description="A JSON array of products available in a listing, even if only one product. All field names in the JSON blobs are lowercase.")
    ...
    listing: Optional[ShopListing] = Field(default=None, description="An enumerated string that attaches a valid association. Default value is null.")
    __properties: ClassVar[List[str]] = ["products", "price_on_property", "quantity_on_property", "sku_on_property", "listing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "products": [ListingInventoryProduct.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None,
            ...
            "listing": ShopListing.from_dict(obj["listing"]) if obj.get("listing") is not None else None
        })
        return _obj
