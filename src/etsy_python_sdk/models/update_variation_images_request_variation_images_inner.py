...
class UpdateVariationImagesRequestVariationImagesInner(BaseModel):
    """
    UpdateVariationImagesRequestVariationImagesInner
    """ # noqa: E501
    property_id: Annotated[int, Field(strict=True, ge=1)]
    value_id: Annotated[int, Field(strict=True, ge=1)]
    image_id: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["property_id", "value_id", "image_id"]
