...
class Payments(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The number of payments in the response.")
    results: Optional[List[Payment]] = Field(default=None, description="A list of payments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "results": [Payment.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
