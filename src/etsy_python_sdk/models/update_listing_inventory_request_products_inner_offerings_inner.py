...
class UpdateListingInventoryRequestProductsInnerOfferingsInner(BaseModel):
    """
    ...
    quantity: StrictInt = Field(description="How many of this product are available?")
    is_enabled: StrictBool = Field(description="True if the offering is shown to buyers")
    __properties: ClassVar[List[str]] = ["price", "quantity", "is_enabled"]
