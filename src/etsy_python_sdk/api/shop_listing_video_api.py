...
class ShopListingVideoApi:
    ...
    def delete_listing_video(
        ...
        video_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of a video associated with a listing.")],
        ...
        :type listing_id: int
        :param video_id: The unique ID of a video associated with a listing. (required)
        :type video_id: int
        ...
        _param = self._delete_listing_video_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def delete_listing_video_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        video_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of a video associated with a listing.")],
    ...
    @validate_call
    def delete_listing_video_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        video_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of a video associated with a listing.")],
    ...
    def _delete_listing_video_serialize(
        self,
        shop_id,
        listing_id,
        video_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v3/application/shops/{shop_id}/listings/{listing_id}/videos/{video_id}',
    ...
    def get_listing_video(
        ...
        _param = self._get_listing_video_serialize(
            video_id=video_id,
            listing_id=listing_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_listing_video_with_http_info(
        self,
        video_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of a video associated with a listing.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_listing_video_without_preload_content(
        self,
        video_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of a video associated with a listing.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        _request_timeout: Union[
    ...
    def _get_listing_video_serialize(
        self,
        video_id,
        listing_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/listings/{listing_id}/videos/{video_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_listing_videos(
        ...
        _param = self._get_listing_videos_serialize(
            listing_id=listing_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_listing_videos_with_http_info(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_listing_videos_without_preload_content(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        _request_timeout: Union[
            None,
    ...
    def _get_listing_videos_serialize(
        self,
        listing_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/listings/{listing_id}/videos',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def upload_listing_video(
        ...
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        video_id: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The unique ID of a video associated with a listing.")] = None,
        video: Annotated[Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]], Field(description="A video file to upload.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="The file name string for the video to upload.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type video_id: int
        :param video: A video file to upload.
        :type video: bytearray
        :param name: The file name string for the video to upload.
        :type name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._upload_listing_video_serialize(
            shop_id=shop_id,
            listing_id=listing_id,
            video_id=video_id,
            video=video,
    ...
    @validate_call
    def upload_listing_video_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        video_id: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The unique ID of a video associated with a listing.")] = None,
    ...
    @validate_call
    def upload_listing_video_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        video_id: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The unique ID of a video associated with a listing.")] = None,
    ...
    def _upload_listing_video_serialize(
        self,
        shop_id,
        listing_id,
        video_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/application/shops/{shop_id}/listings/{listing_id}/videos',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
