...
class ReviewApi:
    ...
    def get_reviews_by_listing(
        ...
        _param = self._get_reviews_by_listing_serialize(
    ...
    @validate_call
    def get_reviews_by_listing_with_http_info(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
    ...
    @validate_call
    def get_reviews_by_listing_without_preload_content(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
    ...
    def _get_reviews_by_listing_serialize(
        self,
        listing_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/listings/{listing_id}/reviews',
    ...
    def get_reviews_by_shop(
        ...
        _param = self._get_reviews_by_shop_serialize(
            shop_id=shop_id,
            limit=limit,
            offset=offset,
            min_created=min_created,
    ...
    @validate_call
    def get_reviews_by_shop_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransactionReviews]:
        """get_reviews_by_shop
    ...
    @validate_call
    def get_reviews_by_shop_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
    ...
    def _get_reviews_by_shop_serialize(
        self,
        shop_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/reviews',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
