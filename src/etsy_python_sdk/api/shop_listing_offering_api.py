...
class ShopListingOfferingApi:
    ...
    def get_listing_offering(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1)],
        product_id: Annotated[int, Field(strict=True, ge=1)],
        product_offering_id: Annotated[int, Field(strict=True, ge=1)],
        ...
        :type product_id: int
        :param product_offering_id:  (required)
        :type product_offering_id: int
        ...
        _param = self._get_listing_offering_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListingInventoryProductOffering",
            '404': "ErrorSchema",
            '400': "ErrorSchema",
            '500': "ErrorSchema",
        }
    ...
    @validate_call
    def get_listing_offering_with_http_info(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1)],
        product_id: Annotated[int, Field(strict=True, ge=1)],
        product_offering_id: Annotated[int, Field(strict=True, ge=1)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListingInventoryProductOffering]:
        """get_listing_offering
    ...
    @validate_call
    def get_listing_offering_without_preload_content(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1)],
        product_id: Annotated[int, Field(strict=True, ge=1)],
        product_offering_id: Annotated[int, Field(strict=True, ge=1)],
    ...
    def _get_listing_offering_serialize(
        self,
        listing_id,
        product_id,
        product_offering_id,
        ...
        if product_offering_id is not None:
            _path_params['product_offering_id'] = product_offering_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/listings/{listing_id}/products/{product_id}/offerings/{product_offering_id}',
