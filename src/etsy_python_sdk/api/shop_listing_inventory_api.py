...
class ShopListingInventoryApi:
    ...
    def get_listing_inventory(
        ...
        show_deleted: Annotated[Optional[StrictBool], Field(description="A boolean value for inventory whether to include deleted products and their offerings. Default value is false.")] = None,
        includes: Annotated[Optional[StrictStr], Field(description="An enumerated string that attaches a valid association. Default value is null.")] = None,
        ...
        :type listing_id: int
        :param show_deleted: A boolean value for inventory whether to include deleted products and their offerings. Default value is false.
        :type show_deleted: bool
        :param includes: An enumerated string that attaches a valid association. Default value is null.
        :type includes: str
        ...
        _param = self._get_listing_inventory_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListingInventoryWithAssociations",
            '404': "ErrorSchema",
            '401': "ErrorSchema",
            '400': "ErrorSchema",
            '422': "ErrorSchema",
    ...
    @validate_call
    def get_listing_inventory_with_http_info(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        show_deleted: Annotated[Optional[StrictBool], Field(description="A boolean value for inventory whether to include deleted products and their offerings. Default value is false.")] = None,
        includes: Annotated[Optional[StrictStr], Field(description="An enumerated string that attaches a valid association. Default value is null.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListingInventoryWithAssociations]:
        """get_listing_inventory
    ...
    @validate_call
    def get_listing_inventory_without_preload_content(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        show_deleted: Annotated[Optional[StrictBool], Field(description="A boolean value for inventory whether to include deleted products and their offerings. Default value is false.")] = None,
        includes: Annotated[Optional[StrictStr], Field(description="An enumerated string that attaches a valid association. Default value is null.")] = None,
    ...
    def _get_listing_inventory_serialize(
        self,
        listing_id,
        show_deleted,
        includes,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/listings/{listing_id}/inventory',
    ...
    def update_listing_inventory(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        update_listing_inventory_request: Optional[UpdateListingInventoryRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param listing_id: The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction. (required)
        :type listing_id: int
        :param update_listing_inventory_request:
        :type update_listing_inventory_request: UpdateListingInventoryRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_listing_inventory_serialize(
            listing_id=listing_id,
            update_listing_inventory_request=update_listing_inventory_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_listing_inventory_with_http_info(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        update_listing_inventory_request: Optional[UpdateListingInventoryRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_listing_inventory_without_preload_content(
        self,
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        update_listing_inventory_request: Optional[UpdateListingInventoryRequest] = None,
        _request_timeout: Union[
    ...
    def _update_listing_inventory_serialize(
        self,
        listing_id,
        update_listing_inventory_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_listing_inventory_request is not None:
            _body_params = update_listing_inventory_request
