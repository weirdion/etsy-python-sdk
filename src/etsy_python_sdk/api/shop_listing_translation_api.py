...
class ShopListingTranslationApi:
    ...
    def create_listing_translation(
        ...
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
        title: Annotated[StrictStr, Field(description="The title of the Listing of this Translation.")],
        description: Annotated[StrictStr, Field(description="The description of the Listing of this Translation.")],
        tags: Annotated[Optional[List[StrictStr]], Field(description="The tags of the Listing of this Translation.")] = None,
        ...
        _param = self._create_listing_translation_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def create_listing_translation_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListingTranslation]:
        """create_listing_translation
    ...
    @validate_call
    def create_listing_translation_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
    ...
    def _create_listing_translation_serialize(
        self,
        shop_id,
        listing_id,
        language,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/application/shops/{shop_id}/listings/{listing_id}/translations/{language}',
    ...
    def get_listing_translation(
        ...
        _param = self._get_listing_translation_serialize(
            shop_id=shop_id,
            listing_id=listing_id,
            language=language,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_listing_translation_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
    ...
    @validate_call
    def get_listing_translation_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
    ...
    def _get_listing_translation_serialize(
        self,
        shop_id,
        listing_id,
        language,
    ...
    def update_listing_translation(
        ...
        _param = self._update_listing_translation_serialize(
            shop_id=shop_id,
            listing_id=listing_id,
            language=language,
            title=title,
    ...
    @validate_call
    def update_listing_translation_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
    ...
    @validate_call
    def update_listing_translation_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        language: Annotated[StrictStr, Field(description="The IETF language tag for the language of this translation. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`.")],
    ...
    def _update_listing_translation_serialize(
        self,
        shop_id,
        listing_id,
        language,
