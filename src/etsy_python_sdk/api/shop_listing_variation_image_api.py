...
class ShopListingVariationImageApi:
    ...
    def get_listing_variation_images(
        ...
        _param = self._get_listing_variation_images_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_listing_variation_images_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListingVariationImages]:
        """get_listing_variation_images
    ...
    @validate_call
    def get_listing_variation_images_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        _request_timeout: Union[
    ...
    def _get_listing_variation_images_serialize(
        self,
        shop_id,
        listing_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/listings/{listing_id}/variation-images',
    ...
    def update_variation_images(
        ...
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        update_variation_images_request: Optional[UpdateVariationImagesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param listing_id: The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction. (required)
        :type listing_id: int
        :param update_variation_images_request:
        :type update_variation_images_request: UpdateVariationImagesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_variation_images_serialize(
            shop_id=shop_id,
            listing_id=listing_id,
            update_variation_images_request=update_variation_images_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_variation_images_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        update_variation_images_request: Optional[UpdateVariationImagesRequest] = None,
    ...
    @validate_call
    def update_variation_images_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        update_variation_images_request: Optional[UpdateVariationImagesRequest] = None,
    ...
    def _update_variation_images_serialize(
        self,
        shop_id,
        listing_id,
        update_variation_images_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_variation_images_request is not None:
            _body_params = update_variation_images_request
