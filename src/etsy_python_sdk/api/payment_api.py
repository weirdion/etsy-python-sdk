...
class PaymentApi:
    ...
    def get_payment_account_ledger_entry_payments(
        ...
        ledger_entry_ids: List[Annotated[int, Field(strict=True, ge=1)]],
        ...
        :type shop_id: int
        :param ledger_entry_ids:  (required)
        :type ledger_entry_ids: List[int]
        ...
        _param = self._get_payment_account_ledger_entry_payments_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_payment_account_ledger_entry_payments_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        ledger_entry_ids: List[Annotated[int, Field(strict=True, ge=1)]],
        _request_timeout: Union[
    ...
    @validate_call
    def get_payment_account_ledger_entry_payments_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        ledger_entry_ids: List[Annotated[int, Field(strict=True, ge=1)]],
        _request_timeout: Union[
    ...
    def _get_payment_account_ledger_entry_payments_serialize(
        self,
        shop_id,
        ledger_entry_ids,
        _request_auth,
        ...
        if ledger_entry_ids is not None:
            ...
            _query_params.append(('ledger_entry_ids', ledger_entry_ids))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/payment-account/ledger-entries/payments',
    ...
    def get_payments(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        payment_ids: Annotated[List[Annotated[int, Field(strict=True, ge=1)]], Field(description="A comma-separated array of Payment IDs numbers.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param shop_id: The unique positive non-zero numeric ID for an Etsy Shop. (required)
        :type shop_id: int
        :param payment_ids: A comma-separated array of Payment IDs numbers. (required)
        :type payment_ids: List[int]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _get_payments_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/payments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_shop_payment_by_receipt_id(
        ...
        _param = self._get_shop_payment_by_receipt_id_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_shop_payment_by_receipt_id_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        receipt_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [receipt](/documentation/reference#tag/Shop-Receipt) associated to this transaction.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_shop_payment_by_receipt_id_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        receipt_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [receipt](/documentation/reference#tag/Shop-Receipt) associated to this transaction.")],
        _request_timeout: Union[
    ...
    def _get_shop_payment_by_receipt_id_serialize(
        self,
        shop_id,
        receipt_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/receipts/{receipt_id}/payments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
