...
class ShopSectionApi:
    ...
    def create_shop_section(
        ...
        title: Annotated[StrictStr, Field(description="The title string for a shop section.")],
        ...
        _param = self._create_shop_section_serialize(
            shop_id=shop_id,
            title=title,
    ...
    @validate_call
    def create_shop_section_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        title: Annotated[StrictStr, Field(description="The title string for a shop section.")],
        _request_timeout: Union[
    ...
    @validate_call
    def create_shop_section_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        title: Annotated[StrictStr, Field(description="The title string for a shop section.")],
        _request_timeout: Union[
    ...
    def _create_shop_section_serialize(
        self,
        shop_id,
        title,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/application/shops/{shop_id}/sections',
    ...
    def delete_shop_section(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param shop_id: The unique positive non-zero numeric ID for an Etsy Shop. (required)
        :type shop_id: int
        :param shop_section_id: The numeric ID of a section in a specific Etsy shop. (required)
        ...
        _param = self._delete_shop_section_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def delete_shop_section_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_shop_section_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        _request_timeout: Union[
    ...
    def _delete_shop_section_serialize(
        self,
        shop_id,
        shop_section_id,
        _request_auth,
        ...
        if shop_section_id is not None:
            _path_params['shop_section_id'] = shop_section_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v3/application/shops/{shop_id}/sections/{shop_section_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_shop_section(
        ...
        _param = self._get_shop_section_serialize(
            shop_id=shop_id,
            shop_section_id=shop_section_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_shop_section_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_shop_section_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        _request_timeout: Union[
    ...
    def _get_shop_section_serialize(
        self,
        shop_id,
        shop_section_id,
        _request_auth,
    ...
    def get_shop_sections(
        ...
        _param = self._get_shop_sections_serialize(
            shop_id=shop_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_shop_sections_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_shop_sections_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        _request_timeout: Union[
            None,
    ...
    def _get_shop_sections_serialize(
        self,
        shop_id,
        _request_auth,
        _content_type,
    ...
    def update_shop_section(
        ...
        _param = self._update_shop_section_serialize(
            shop_id=shop_id,
            shop_section_id=shop_section_id,
            title=title,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_shop_section_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        title: Annotated[StrictStr, Field(description="The title string for a shop section.")],
    ...
    @validate_call
    def update_shop_section_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        shop_section_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of a section in a specific Etsy shop.")],
        title: Annotated[StrictStr, Field(description="The title string for a shop section.")],
    ...
    def _update_shop_section_serialize(
        self,
        shop_id,
        shop_section_id,
        title,
