...
class ShopProductionPartnerApi:
    ...
    def get_shop_production_partners(
        ...
        _param = self._get_shop_production_partners_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_shop_production_partners_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShopProductionPartners]:
        """get_shop_production_partners
    ...
    @validate_call
    def get_shop_production_partners_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        _request_timeout: Union[
            None,
    ...
    def _get_shop_production_partners_serialize(
        self,
        shop_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/production-partners',
