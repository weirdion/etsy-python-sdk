...
class ShopReceiptTransactionsApi:
    ...
    def get_shop_receipt_transaction(
        ...
        transaction_id: Annotated[int, Field(strict=True, ge=1, description="The unique numeric ID for a transaction.")],
        ...
        :type shop_id: int
        :param transaction_id: The unique numeric ID for a transaction. (required)
        ...
        _param = self._get_shop_receipt_transaction_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_shop_receipt_transaction_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        transaction_id: Annotated[int, Field(strict=True, ge=1, description="The unique numeric ID for a transaction.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShopReceiptTransaction]:
        """get_shop_receipt_transaction
    ...
    @validate_call
    def get_shop_receipt_transaction_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        transaction_id: Annotated[int, Field(strict=True, ge=1, description="The unique numeric ID for a transaction.")],
        _request_timeout: Union[
    ...
    def _get_shop_receipt_transaction_serialize(
        self,
        shop_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/transactions/{transaction_id}',
    ...
    def get_shop_receipt_transactions_by_listing(
        ...
        _param = self._get_shop_receipt_transactions_by_listing_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_shop_receipt_transactions_by_listing_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShopReceiptTransactions]:
        """get_shop_receipt_transactions_by_listing
    ...
    @validate_call
    def get_shop_receipt_transactions_by_listing_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        listing_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [listing](/documentation/reference#tag/ShopListing) associated to this transaction.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
    ...
    def _get_shop_receipt_transactions_by_listing_serialize(
        self,
        shop_id,
        listing_id,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/listings/{listing_id}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_shop_receipt_transactions_by_receipt(
        ...
        _param = self._get_shop_receipt_transactions_by_receipt_serialize(
            shop_id=shop_id,
    ...
    @validate_call
    def get_shop_receipt_transactions_by_receipt_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        receipt_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [receipt](/documentation/reference#tag/Shop-Receipt) associated to this transaction.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_shop_receipt_transactions_by_receipt_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        receipt_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID for the [receipt](/documentation/reference#tag/Shop-Receipt) associated to this transaction.")],
        _request_timeout: Union[
    ...
    def _get_shop_receipt_transactions_by_receipt_serialize(
        self,
        shop_id,
        receipt_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/receipts/{receipt_id}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_shop_receipt_transactions_by_shop(
        ...
        _param = self._get_shop_receipt_transactions_by_shop_serialize(
            shop_id=shop_id,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_shop_receipt_transactions_by_shop_with_http_info(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
    ...
    @validate_call
    def get_shop_receipt_transactions_by_shop_without_preload_content(
        self,
        shop_id: Annotated[int, Field(strict=True, ge=1, description="The unique positive non-zero numeric ID for an Etsy Shop.")],
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
    ...
    def _get_shop_receipt_transactions_by_shop_serialize(
        self,
        shop_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/shops/{shop_id}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
