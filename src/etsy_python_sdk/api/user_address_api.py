...
class UserAddressApi:
    ...
    def delete_user_address(
        self,
        user_address_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of the user's address.")],
        ...
        :param user_address_id: The numeric ID of the user's address. (required)
        :type user_address_id: int
    ...
    def _delete_user_address_serialize(
        ...
        if user_address_id is not None:
            _path_params['user_address_id'] = user_address_id
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v3/application/user/addresses/{user_address_id}',
    ...
    def get_user_address(
        ...
        _param = self._get_user_address_serialize(
            user_address_id=user_address_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_user_address_with_http_info(
        self,
        user_address_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of the user's address.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_user_address_without_preload_content(
        self,
        user_address_id: Annotated[int, Field(strict=True, ge=1, description="The numeric ID of the user's address.")],
        _request_timeout: Union[
            None,
    ...
    def _get_user_address_serialize(
        self,
        user_address_id,
        _request_auth,
        _content_type,
    ...
    def get_user_addresses(
        ...
        _param = self._get_user_addresses_serialize(
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_addresses_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_addresses_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="The maximum number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The number of records to skip before selecting the first result.")] = None,
        _request_timeout: Union[
    ...
    def _get_user_addresses_serialize(
        self,
        limit,
        offset,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/application/user/addresses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
