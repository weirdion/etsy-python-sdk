...
class TestPaymentAdjustmentItem(unittest.TestCase):
    """PaymentAdjustmentItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentAdjustmentItem:
        """Test PaymentAdjustmentItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentAdjustmentItem`
        """
        model = PaymentAdjustmentItem()
        if include_optional:
    ...
    def testPaymentAdjustmentItem(self):
        """Test PaymentAdjustmentItem"""
