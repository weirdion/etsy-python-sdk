...
with etsy_python_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = etsy_python_sdk.OtherApi(api_client)

    try:
        api_response = api_instance.ping()
        print("The response of OtherApi->ping:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherApi->ping: %s\n" % e)
```
...
with etsy_python_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.token_scopes(token)
        print("The response of OtherApi->token_scopes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherApi->token_scopes: %s\n" % e)
```
